...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        textEdit->setGeometry(QRect(20, 220, 1981, 741));
        showListButton = new QPushButton(centralwidget);
        showListButton->setObjectName("showListButton");
        showListButton->setGeometry(QRect(800, 113, 281, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        showListButton->setText(QCoreApplication::translate("MainWindow", "Show details", nullptr));
        menuFleetManager->setTitle(QCoreApplication::translate("MainWindow", "FleetManager", nullptr));
